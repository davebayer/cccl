...
#ifndef _CUDA___BIT_POPCOUNT_H
#define _CUDA___BIT_POPCOUNT_H
...
{
  return _CUDA_VSTD::popcount(__v);
}
...
[[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI constexpr int popcount(_Tp __v) noexcept
{
  return _CUDA_VSTD::popcount(_CUDA_VSTD::__to_unsigned_like(static_cast<__bitmask_value_type_t<_Tp>>(__v)));
}
