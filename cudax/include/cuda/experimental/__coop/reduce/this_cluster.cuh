...
#ifndef _CUDA_EXPERIMENTAL___COOP_REDUCE_THIS_CLUSTER_CUH
#define _CUDA_EXPERIMENTAL___COOP_REDUCE_THIS_CLUSTER_CUH
...
struct __reduce_impl<_Broadcasted,
                     ...
                     _Np,
                     _RedFn,
                     ::cuda::std::enable_if_t<::cuda::std::is_same_v<typename _Group::unit_type, cluster_level>&& ::
                                                cuda::std::is_same_v<typename _Group::level_type, cluster_level>>>
{
  using _ClusterExts = decltype(block.extents(cluster, ::cuda::std::declval<typename _Group::hierarchy_type>()));
...
#endif // _CUDA_EXPERIMENTAL___COOP_REDUCE_THIS_CLUSTER_CUH
