...
public:
  ...
  _LIBCPP_HIDE_FROM_ABI explicit tzdb_list(__impl* __p)
      : __impl_(__p)
  {
  ...
  [[nodiscard]] _LIBCPP_HIDE_FROM_ABI const tzdb& front() const noexcept
  {
    return __front();
  }
  ...
  [[nodiscard]] _LIBCPP_HIDE_FROM_ABI const_iterator cbegin() const noexcept
  {
    return __cbegin();
  }
  [[nodiscard]] _LIBCPP_HIDE_FROM_ABI const_iterator cend() const noexcept
  {
    return __cend();
  }

  [[nodiscard]] _LIBCPP_HIDE_FROM_ABI __impl& __implementation()
  {
    return *__impl_;
  }
