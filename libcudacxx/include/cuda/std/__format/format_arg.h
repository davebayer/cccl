...
_LIBCUDACXX_HIDE_FROM_ABI constexpr bool __use_packed_format_arg_store(size_t __size)
{
  return __size <= __packed_types_max;
}

_LIBCUDACXX_HIDE_FROM_ABI constexpr __arg_t __get_packed_type(uint64_t __types, size_t __id)
{
  _CCCL_ASSERT(__id <= __packed_types_max, "");
...
_LIBCUDACXX_HIDE_FROM_ABI decltype(auto) __visit_format_arg(_Visitor&& __vis, basic_format_arg<_Context> __arg)
{
...
class __basic_format_arg_value
{
  ...
  __format_impl(basic_format_parse_context<_CharT>& __parse_ctx, _Context& __ctx, const void* __ptr)
  {
...
public:
  ...
  _LIBCUDACXX_HIDE_FROM_ABI __basic_format_arg_value() noexcept
      : __monostate_()
  {}
  _LIBCUDACXX_HIDE_FROM_ABI __basic_format_arg_value(bool __value) noexcept
      : __boolean_(__value)
  {}
  _LIBCUDACXX_HIDE_FROM_ABI __basic_format_arg_value(_CharT __value) noexcept
      : __char_type_(__value)
  {}
  _LIBCUDACXX_HIDE_FROM_ABI __basic_format_arg_value(int __value) noexcept
      : __int_(__value)
  {}
  _LIBCUDACXX_HIDE_FROM_ABI __basic_format_arg_value(unsigned __value) noexcept
      : __unsigned_(__value)
  {}
  _LIBCUDACXX_HIDE_FROM_ABI __basic_format_arg_value(long long __value) noexcept
  ...
  {}
#if _CCCL_HAS_INT128()
  _LIBCUDACXX_HIDE_FROM_ABI __basic_format_arg_value(__int128_t __value) noexcept
      : __i128_(__value)
  {}
  _LIBCUDACXX_HIDE_FROM_ABI __basic_format_arg_value(__uint128_t __value) noexcept
      : __u128_(__value)
  {}
#endif // _CCCL_HAS_INT128()
  _LIBCUDACXX_HIDE_FROM_ABI __basic_format_arg_value(float __value) noexcept
      : __float_(__value)
  {}
  _LIBCUDACXX_HIDE_FROM_ABI __basic_format_arg_value(double __value) noexcept
      : __double_(__value)
  {}
#if _CCCL_HAS_LONG_DOUBLE()
  _LIBCUDACXX_HIDE_FROM_ABI __basic_format_arg_value(long double __value) noexcept
      : __long_double_(__value)
  {}
#endif // _CCCL_HAS_LONG_DOUBLE()
  _LIBCUDACXX_HIDE_FROM_ABI __basic_format_arg_value(const _CharT* __value) noexcept
  ...
  {}
  _LIBCUDACXX_HIDE_FROM_ABI __basic_format_arg_value(const void* __value) noexcept
      : __ptr_(__value)
  {}
...
public:
  ...
  _LIBCUDACXX_HIDE_FROM_ABI explicit basic_format_arg(
    __format::__arg_t __type, __basic_format_arg_value<_Context> __value) noexcept
      : __value_(__value)
      , __type_(__type)
  {}
};
...
{
public:
  _LIBCUDACXX_HIDE_FROM_ABI void format(basic_format_parse_context<char_type>& __parse_ctx, _Context& __ctx) const
  {
...
template <class _Visitor, class _Context>
[[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI decltype(auto)
visit_format_arg(_Visitor&& __vis, basic_format_arg<_Context> __arg)
{
  switch (__arg.__type_)
  {
    ...
    case __format::__arg_t::__i128: {
      ...
      return _CUDA_VSTD::invoke(_CUDA_VSTD::forward<_Visitor>(__vis), typename basic_format_arg<_Context>::handle{__h});
    }
...
#endif // // _CCCL_HAS_INT128()
    default:
      return _CUDA_VSTD::__visit_format_arg(_CUDA_VSTD::forward<_Visitor>(__vis), __arg);
  }
}
