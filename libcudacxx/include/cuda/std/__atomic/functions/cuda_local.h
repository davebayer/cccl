...
{
  if (!_CUDA_VSTD::__cuda_is_local(__ptr))
  {
    return false;
  }
...
__cuda_compare_exchange_weak_if_local(volatile _Type* __ptr, _Type* __expected, const _Type* __desired, bool* __success)
{
  ...
  if (_CUDA_VSTD::__atomic_memcmp(const_cast<const _Type*>(__ptr), const_cast<const _Type*>(__expected), sizeof(_Type))
      == 0)
  {
...
{
  return _CUDA_VSTD::__cuda_fetch_weak_if_local(__ptr, __val, __ret, _CUDA_VSTD::__cuda_fetch_local_bop_and<_Type>);
}

template <class _Type>
_CCCL_DEVICE bool __cuda_fetch_or_weak_if_local(volatile _Type* __ptr, _Type __val, _Type* __ret)
{
  return _CUDA_VSTD::__cuda_fetch_weak_if_local(__ptr, __val, __ret, _CUDA_VSTD::__cuda_fetch_local_bop_or<_Type>);
}

template <class _Type>
_CCCL_DEVICE bool __cuda_fetch_xor_weak_if_local(volatile _Type* __ptr, _Type __val, _Type* __ret)
{
  return _CUDA_VSTD::__cuda_fetch_weak_if_local(__ptr, __val, __ret, _CUDA_VSTD::__cuda_fetch_local_bop_xor<_Type>);
}

template <class _Type>
_CCCL_DEVICE bool __cuda_fetch_add_weak_if_local(volatile _Type* __ptr, _Type __val, _Type* __ret)
{
  return _CUDA_VSTD::__cuda_fetch_weak_if_local(__ptr, __val, __ret, _CUDA_VSTD::__cuda_fetch_local_bop_add<_Type>);
}

template <class _Type>
_CCCL_DEVICE bool __cuda_fetch_sub_weak_if_local(volatile _Type* __ptr, _Type __val, _Type* __ret)
{
  return _CUDA_VSTD::__cuda_fetch_weak_if_local(__ptr, __val, __ret, _CUDA_VSTD::__cuda_fetch_local_bop_sub<_Type>);
}

template <class _Type>
_CCCL_DEVICE bool __cuda_fetch_max_weak_if_local(volatile _Type* __ptr, _Type __val, _Type* __ret)
{
  return _CUDA_VSTD::__cuda_fetch_weak_if_local(__ptr, __val, __ret, _CUDA_VSTD::__cuda_fetch_local_bop_max<_Type>);
}

template <class _Type>
_CCCL_DEVICE bool __cuda_fetch_min_weak_if_local(volatile _Type* __ptr, _Type __val, _Type* __ret)
{
  return _CUDA_VSTD::__cuda_fetch_weak_if_local(__ptr, __val, __ret, _CUDA_VSTD::__cuda_fetch_local_bop_min<_Type>);
}
