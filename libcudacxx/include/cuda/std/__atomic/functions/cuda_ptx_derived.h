...
template <class _Tp, class _Fn, class _Sco>
...
template <class _Tp, class _Up, class _Sco, __atomic_enable_if_not_native_arithmetic<_Tp> = 0>
...
template <class _Tp, class _Up, class _Sco, __atomic_enable_if_not_native_bitwise<_Tp> = 0>
...
template <class _Tp, class _Up, class _Sco, __atomic_enable_if_not_native_minmax<_Tp> = 0>
