...
{
  {
    ...
    cuda::std::same_as<cuda::std::constant_wrapper<9>> decltype(auto) result = cw6 + cw3;
    static_assert(result == 9);

    cuda::std::same_as<cuda::std::constant_wrapper<3>> decltype(auto) result2 = cw6 - cw3;
    static_assert(result2 == 3);

    cuda::std::same_as<cuda::std::constant_wrapper<18>> decltype(auto) result3 = cw6 * cw3;
    static_assert(result3 == 18);

    cuda::std::same_as<cuda::std::constant_wrapper<2>> decltype(auto) result4 = cw6 / cw3;
    static_assert(result4 == 2);

    cuda::std::same_as<cuda::std::constant_wrapper<0>> decltype(auto) result5 = cw6 % cw3;
    static_assert(result5 == 0);

    cuda::std::same_as<cuda::std::constant_wrapper<2>> decltype(auto) result6 = cw6 & cw3;
    static_assert(result6 == 2);

    cuda::std::same_as<cuda::std::constant_wrapper<7>> decltype(auto) result7 = cw6 | cw3;
    static_assert(result7 == 7);

    cuda::std::same_as<cuda::std::constant_wrapper<5>> decltype(auto) result8 = cw6 ^ cw3;
    static_assert(result8 == 5);

    // Shift operations: 6 << 3 = 48, 6 >> 3 = 0
    cuda::std::same_as<cuda::std::constant_wrapper<48>> decltype(auto) result9 = cw6 << cw3;
    static_assert(result9 == 48);

    cuda::std::same_as<cuda::std::constant_wrapper<0>> decltype(auto) result10 = cw6 >> cw3;
...

  {
    ...
    cuda::std::same_as<cuda::std::constant_wrapper<WithOps{9}>> decltype(auto) result = cwWithOps6 + cwWithOps3;
    static_assert(result.value.value == 9);

    cuda::std::same_as<cuda::std::constant_wrapper<WithOps{3}>> decltype(auto) result2 = cwWithOps6 - cwWithOps3;
    static_assert(result2.value.value == 3);

    cuda::std::same_as<cuda::std::constant_wrapper<WithOps{18}>> decltype(auto) result3 = cwWithOps6 * cwWithOps3;
    static_assert(result3.value.value == 18);

    cuda::std::same_as<cuda::std::constant_wrapper<WithOps{2}>> decltype(auto) result4 = cwWithOps6 / cwWithOps3;
    static_assert(result4.value.value == 2);

    cuda::std::same_as<cuda::std::constant_wrapper<WithOps{0}>> decltype(auto) result5 = cwWithOps6 % cwWithOps3;
    static_assert(result5.value.value == 0);

    cuda::std::same_as<cuda::std::constant_wrapper<WithOps{2}>> decltype(auto) result6 = cwWithOps6 & cwWithOps3;
    static_assert(result6.value.value == 2);

    cuda::std::same_as<cuda::std::constant_wrapper<WithOps{7}>> decltype(auto) result7 = cwWithOps6 | cwWithOps3;
    static_assert(result7.value.value == 7);

    cuda::std::same_as<cuda::std::constant_wrapper<WithOps{5}>> decltype(auto) result8 = cwWithOps6 ^ cwWithOps3;
    static_assert(result8.value.value == 5);

    // Shift operations: 6 << 3 = 48, 6 >> 3 = 0
    cuda::std::same_as<cuda::std::constant_wrapper<WithOps{48}>> decltype(auto) result9 = cwWithOps6 << cwWithOps3;
    static_assert(result9.value.value == 48);

    cuda::std::same_as<cuda::std::constant_wrapper<WithOps{0}>> decltype(auto) result10 = cwWithOps6 >> cwWithOps3;
    static_assert(result10.value.value == 0);

    cuda::std::same_as<cuda::std::constant_wrapper<WithOps{1}>> decltype(auto) result11 = cwWithOps6 && cwWithOps3;
    static_assert(result11.value.value == 1);

    cuda::std::same_as<cuda::std::constant_wrapper<WithOps{1}>> decltype(auto) result12 = cwWithOps6 || cwWithOps3;
...

  {
    ...
    cuda::std::same_as<cuda::std::constant_wrapper<9>> decltype(auto) result = cw6 + ic3;
    static_assert(result == 9);

    cuda::std::same_as<cuda::std::constant_wrapper<3>> decltype(auto) result2 = cw6 - ic3;
    static_assert(result2 == 3);

    cuda::std::same_as<cuda::std::constant_wrapper<18>> decltype(auto) result3 = cw6 * ic3;
    static_assert(result3 == 18);

    cuda::std::same_as<cuda::std::constant_wrapper<2>> decltype(auto) result4 = cw6 / ic3;
    static_assert(result4 == 2);

    cuda::std::same_as<cuda::std::constant_wrapper<0>> decltype(auto) result5 = cw6 % ic3;
    static_assert(result5 == 0);

    cuda::std::same_as<cuda::std::constant_wrapper<2>> decltype(auto) result6 = cw6 & ic3;
    static_assert(result6 == 2);

    cuda::std::same_as<cuda::std::constant_wrapper<7>> decltype(auto) result7 = cw6 | ic3;
    static_assert(result7 == 7);

    cuda::std::same_as<cuda::std::constant_wrapper<5>> decltype(auto) result8 = cw6 ^ ic3;
    static_assert(result8 == 5);

    // Shift operations: 6 << 3 = 48, 6 >> 3 = 0
    cuda::std::same_as<cuda::std::constant_wrapper<48>> decltype(auto) result9 = cw6 << ic3;
    static_assert(result9 == 48);

    cuda::std::same_as<cuda::std::constant_wrapper<0>> decltype(auto) result10 = cw6 >> ic3;
    static_assert(result10 == 0);
