...
[[nodiscard]] _CCCL_MALLOC(cuda::std::free, 2) _CCCL_ALLOC_ALIGN(1) _CCCL_ALLOC_SIZE(2) _CCCL_HOST_DEVICE_API
  inline void* aligned_alloc(size_t __align, size_t __nbytes) noexcept
{
