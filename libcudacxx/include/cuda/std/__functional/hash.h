...
using __check_hash_requirements _CCCL_NODEBUG_ALIAS =
  integral_constant<bool,
                    _CCCL_TRAIT(is_copy_constructible, _Hash) && _CCCL_TRAIT(is_move_constructible, _Hash)
                      && __invokable_r<size_t, _Hash, _Key const&>::value>;

template <class _Key, class _Hash = hash<_Key>>
using __has_enabled_hash _CCCL_NODEBUG_ALIAS =
  integral_constant<bool, __check_hash_requirements<_Key, _Hash>::value && _CCCL_TRAIT(is_default_constructible, _Hash)>;
