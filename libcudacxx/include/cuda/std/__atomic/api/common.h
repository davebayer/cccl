...
#define _LIBCUDACXX_ATOMIC_COMMON_IMPL(_CONST, _VOLATILE)                                                               \
  ...
  {                                                                                                                     \
    _CUDA_VSTD::__atomic_store_dispatch(&__a, __d, __m, _Sco{});                                                        \
  }                                                                                                                     \
  ...
  {                                                                                                                     \
    return _CUDA_VSTD::__atomic_load_dispatch(&__a, __m, _Sco{});                                                       \
  }                                                                                                                     \
  ...
  {                                                                                                                     \
    return _CUDA_VSTD::__atomic_exchange_dispatch(&__a, __d, __m, _Sco{});                                              \
  }                                                                                                                     \
  ...
  {                                                                                                                     \
    return _CUDA_VSTD::__atomic_compare_exchange_weak_dispatch(&__a, &__e, __d, __s, __f, _Sco{});                      \
  }                                                                                                                     \
  _CCCL_HOST_DEVICE inline bool compare_exchange_strong(_Tp& __e, _Tp __d, memory_order __s, memory_order __f)          \
    _CONST _VOLATILE noexcept _LIBCUDACXX_CHECK_EXCHANGE_MEMORY_ORDER(__s, __f)                                         \
  {                                                                                                                     \
    return _CUDA_VSTD::__atomic_compare_exchange_strong_dispatch(&__a, &__e, __d, __s, __f, _Sco{});                    \
  }                                                                                                                     \
  ...
  {                                                                                                                     \
    if (memory_order_acq_rel == __m)                                                                                    \
      return _CUDA_VSTD::__atomic_compare_exchange_weak_dispatch(&__a, &__e, __d, __m, memory_order_acquire, _Sco{});   \
    else if (memory_order_release == __m)                                                                               \
      return _CUDA_VSTD::__atomic_compare_exchange_weak_dispatch(&__a, &__e, __d, __m, memory_order_relaxed, _Sco{});   \
    else                                                                                                                \
      return _CUDA_VSTD::__atomic_compare_exchange_weak_dispatch(&__a, &__e, __d, __m, __m, _Sco{});                    \
  }                                                                                                                     \
  _CCCL_HOST_DEVICE inline bool compare_exchange_strong(_Tp& __e, _Tp __d, memory_order __m = memory_order_seq_cst)     \
    _CONST _VOLATILE noexcept                                                                                           \
  {                                                                                                                     \
    if (memory_order_acq_rel == __m)                                                                                    \
      return _CUDA_VSTD::__atomic_compare_exchange_strong_dispatch(&__a, &__e, __d, __m, memory_order_acquire, _Sco{}); \
    else if (memory_order_release == __m)                                                                               \
      return _CUDA_VSTD::__atomic_compare_exchange_strong_dispatch(&__a, &__e, __d, __m, memory_order_relaxed, _Sco{}); \
    else                                                                                                                \
      return _CUDA_VSTD::__atomic_compare_exchange_strong_dispatch(&__a, &__e, __d, __m, __m, _Sco{});                  \
  }                                                                                                                     \
  _CCCL_HOST_DEVICE inline void wait(_Tp __v, memory_order __m = memory_order_seq_cst) const _VOLATILE noexcept         \
  {                                                                                                                     \
    _CUDA_VSTD::__atomic_wait(&__a, __v, __m, _Sco{});                                                                  \
  }                                                                                                                     \
  _CCCL_HOST_DEVICE inline void notify_one() _CONST _VOLATILE noexcept                                                  \
  {                                                                                                                     \
    _CUDA_VSTD::__atomic_notify_one(&__a, _Sco{});                                                                      \
  }                                                                                                                     \
  _CCCL_HOST_DEVICE inline void notify_all() _CONST _VOLATILE noexcept                                                  \
  {                                                                                                                     \
    _CUDA_VSTD::__atomic_notify_all(&__a, _Sco{});                                                                      \
  }
...
#define _LIBCUDACXX_ATOMIC_ARITHMETIC_IMPL(_CONST, _VOLATILE)                                                         \
  ...
  {                                                                                                                   \
    return _CUDA_VSTD::__atomic_fetch_add_dispatch(&__a, __op, __m, _Sco{});                                          \
  }                                                                                                                   \
  _CCCL_HOST_DEVICE inline _Tp fetch_sub(_Tp __op, memory_order __m = memory_order_seq_cst) _CONST _VOLATILE noexcept \
  {                                                                                                                   \
    return _CUDA_VSTD::__atomic_fetch_sub_dispatch(&__a, __op, __m, _Sco{});                                          \
  }                                                                                                                   \
...
#define _LIBCUDACXX_ATOMIC_POINTER_IMPL(_CONST, _VOLATILE)                                        \
  _CCCL_HOST_DEVICE inline _Tp fetch_add(ptrdiff_t __op, memory_order __m = memory_order_seq_cst) \
    _CONST _VOLATILE noexcept                                                                     \
  {                                                                                               \
    return _CUDA_VSTD::__atomic_fetch_add_dispatch(&__a, __op, __m, __thread_scope_system_tag{}); \
  }                                                                                               \
  _CCCL_HOST_DEVICE inline _Tp fetch_sub(ptrdiff_t __op, memory_order __m = memory_order_seq_cst) \
    _CONST _VOLATILE noexcept                                                                     \
  {                                                                                               \
    return _CUDA_VSTD::__atomic_fetch_sub_dispatch(&__a, __op, __m, __thread_scope_system_tag{}); \
  }                                                                                               \
  _CCCL_HOST_DEVICE inline _Tp operator++(int) _CONST _VOLATILE noexcept                          \
  {                                                                                               \
    return fetch_add(1);                                                                          \
