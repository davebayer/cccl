...
struct WithOps
{
  ...
  constexpr auto operator+=(WithOps r) const
  {
...
struct OpsReturnNonStructural
{
  ...
  constexpr OpsReturnNonStructural(int v)
      : value(v)
  {}
  ...
  constexpr auto operator+=(OpsReturnNonStructural r) const
  {
