...
_CCCL_NODISCARD _LIBCUDACXX_HIDE_FROM_ABI _To __cccl_fp_cvt_to(_From __v) noexcept;
...
template <>
_CCCL_NODISCARD _LIBCUDACXX_HIDE_FROM_ABI constexpr float __cccl_fp_cvt_to(float __v) noexcept
{
  return __v;
}
...
template <>
_CCCL_NODISCARD _LIBCUDACXX_HIDE_FROM_ABI constexpr float __cccl_fp_cvt_to(double __v) noexcept
{
  return __v;
}
...
template <>
_CCCL_NODISCARD _LIBCUDACXX_HIDE_FROM_ABI float __cccl_fp_cvt_to(__half __v) noexcept
{
...
template <>
_CCCL_NODISCARD _LIBCUDACXX_HIDE_FROM_ABI float __cccl_fp_cvt_to(__nv_bfloat16 __v) noexcept
{
...
template <>
_CCCL_NODISCARD _LIBCUDACXX_HIDE_FROM_ABI __nv_bfloat16 __cccl_fp_cvt_to(__nv_fp8_e4m3 __v) noexcept
{
  return _CUDA_VSTD::make_nvbf16_from_storage(
    ::__nv_cvt_fp8_to_halfraw(_CUDA_VSTD::__cccl_fp_get_storage(__v), __NV_E4M3).x);
}

template <>
_CCCL_NODISCARD _LIBCUDACXX_HIDE_FROM_ABI float __cccl_fp_cvt_to(__nv_fp8_e4m3 __v) noexcept
{
  return _CUDA_VSTD::__cccl_fp_cvt_to<float>(_CUDA_VSTD::__cccl_fp_cvt_to<__nv_bfloat16>(__v));
}
...
template <>
_CCCL_NODISCARD _LIBCUDACXX_HIDE_FROM_ABI __nv_bfloat16 __cccl_fp_cvt_to(__nv_fp8_e5m2 __v) noexcept
{
  return _CUDA_VSTD::make_nvbf16_from_storage(
    ::__nv_cvt_fp8_to_halfraw(_CUDA_VSTD::__cccl_fp_get_storage(__v), __NV_E5M2).x);
}

template <>
_CCCL_NODISCARD _LIBCUDACXX_HIDE_FROM_ABI float __cccl_fp_cvt_to(__nv_fp8_e5m2 __v) noexcept
{
  return _CUDA_VSTD::__cccl_fp_cvt_to<float>(_CUDA_VSTD::__cccl_fp_cvt_to<__nv_bfloat16>(__v));
}
...
template <>
_CCCL_NODISCARD _LIBCUDACXX_HIDE_FROM_ABI __nv_bfloat16 __cccl_fp_cvt_to(__nv_fp8_e8m0 __v) noexcept
{
  return _CUDA_VSTD::make_nvbf16_from_storage(::__nv_cvt_e8m0_to_bf16raw(_CUDA_VSTD::__cccl_fp_get_storage(__v)).x);
}

template <>
_CCCL_NODISCARD _LIBCUDACXX_HIDE_FROM_ABI float __cccl_fp_cvt_to(__nv_fp8_e8m0 __v) noexcept
{
  return _CUDA_VSTD::__cccl_fp_cvt_to<float>(_CUDA_VSTD::__cccl_fp_cvt_to<__nv_bfloat16>(__v));
}
...
template <>
_CCCL_NODISCARD _LIBCUDACXX_HIDE_FROM_ABI __half __cccl_fp_cvt_to(__nv_fp6_e2m3 __v) noexcept
{
  return _CUDA_VSTD::make_nvfp16_from_storage(
    ::__nv_cvt_fp6_to_halfraw(_CUDA_VSTD::__cccl_fp_get_storage(__v), __NV_E2M3).x);
}

template <>
_CCCL_NODISCARD _LIBCUDACXX_HIDE_FROM_ABI float __cccl_fp_cvt_to(__nv_fp6_e2m3 __v) noexcept
{
  return _CUDA_VSTD::__cccl_fp_cvt_to<float>(_CUDA_VSTD::__cccl_fp_cvt_to<__half>(__v));
}
...
template <>
_CCCL_NODISCARD _LIBCUDACXX_HIDE_FROM_ABI __half __cccl_fp_cvt_to(__nv_fp6_e3m2 __v) noexcept
{
  return _CUDA_VSTD::make_nvfp16_from_storage(
    ::__nv_cvt_fp6_to_halfraw(_CUDA_VSTD::__cccl_fp_get_storage(__v), __NV_E3M2).x);
}

template <>
_CCCL_NODISCARD _LIBCUDACXX_HIDE_FROM_ABI float __cccl_fp_cvt_to(__nv_fp6_e3m2 __v) noexcept
{
  return _CUDA_VSTD::__cccl_fp_cvt_to<float>(_CUDA_VSTD::__cccl_fp_cvt_to<__half>(__v));
}
...
template <>
_CCCL_NODISCARD _LIBCUDACXX_HIDE_FROM_ABI __half __cccl_fp_cvt_to(__nv_fp4_e2m1 __v) noexcept
{
  return _CUDA_VSTD::make_nvfp16_from_storage(
    ::__nv_cvt_fp4_to_halfraw(_CUDA_VSTD::__cccl_fp_get_storage(__v), __NV_E2M1).x);
}

template <>
_CCCL_NODISCARD _LIBCUDACXX_HIDE_FROM_ABI float __cccl_fp_cvt_to(__nv_fp4_e2m1 __v) noexcept
{
  return _CUDA_VSTD::__cccl_fp_cvt_to<float>(_CUDA_VSTD::__cccl_fp_cvt_to<__half>(__v));
}
