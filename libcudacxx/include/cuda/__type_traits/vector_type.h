...
template <>
struct _CCCL_TYPE_VISIBILITY_DEFAULT vector_type<::__nv_fp8_ue5m3, 2>
{
  using type = ::__nv_fp8x2_ue5m3;
};
template <>
struct _CCCL_TYPE_VISIBILITY_DEFAULT vector_type<::__nv_fp8_ue5m3, 4>
{
  using type = ::__nv_fp8x4_ue5m3;
};
