...
{
  {
    ...
    cuda::std::same_as<cuda::std::constant_wrapper<42>> decltype(auto) result = +cw42;
    static_assert(result == 42);

    cuda::std::same_as<cuda::std::constant_wrapper<-42>> decltype(auto) result2 = -cw42;
    static_assert(result2 == -42);

    cuda::std::same_as<cuda::std::constant_wrapper<~42>> decltype(auto) result3 = ~cw42;
    static_assert(result3 == ~42);

    cuda::std::same_as<cuda::std::constant_wrapper<!42>> decltype(auto) result4 = !cw42;
    static_assert(result4 == !42);

    cuda::std::same_as<cuda::std::constant_wrapper<&cw42.value>> decltype(auto) result5 = &cw42;
