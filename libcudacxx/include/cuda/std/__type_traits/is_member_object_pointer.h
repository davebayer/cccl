...
is_member_object_pointer : bool_constant<_CCCL_BUILTIN_IS_MEMBER_OBJECT_POINTER(_Tp)>
{};
...
template <class _Tp>
inline constexpr bool is_member_object_pointer_v = __cccl_is_member_pointer<remove_cv_t<_Tp>>::__is_obj;

template <class _Tp>
struct _CCCL_TYPE_VISIBILITY_DEFAULT is_member_object_pointer : bool_constant<is_member_object_pointer_v<_Tp>>
{};
