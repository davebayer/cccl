...
// clang-format off
static_assert(cuda::std::is_invocable_v<cuda::std::constant_wrapper<[] { return 42; }>>);
static_assert(!cuda::std::is_invocable_v<cuda::std::constant_wrapper<[] { return 42; }>, int>);
...
{
  {
    ...
    cuda::std::same_as<int> decltype(auto) result = T::operator()(1, 2);
    assert(result == 3);
  }

  {
    ...
    using T                                       = cuda::std::constant_wrapper<cuda::std::plus<>{}>;
    cuda::std::same_as<int> decltype(auto) result = T::operator()(cuda::std::cw<1>, 2);
    assert(result == 3);
  }

  {
    ...
    cuda::std::same_as<cuda::std::constant_wrapper<3>> decltype(auto) result =
      T::operator()(cuda::std::cw<1>, cuda::std::cw<2>);
    static_assert(result == 3);
  }

  {
    // nullary
    using T                                                                   = cuda::std::constant_wrapper<[] {
      return 42;
                                                                      }>;
    cuda::std::same_as<cuda::std::constant_wrapper<42>> decltype(auto) result = T::operator()();
    static_assert(result == 42);
  }

  {
    // return void with runtime param
    using T = cuda::std::constant_wrapper<[](int) {}>;
    T::operator()(5);
    static_assert(cuda::std::same_as<void, decltype(T::operator()(5))>);
  }

  {
    // return void with constexpr param
    using T = cuda::std::constant_wrapper<[](int) {}>;
    T::operator()(cuda::std::cw<5>);
    static_assert(cuda::std::same_as<void, decltype(T::operator()(cuda::std::cw<5>))>);
  }

  {
    ...
    using T = cuda::std::constant_wrapper<[] {}>;
    T::operator()();
    static_assert(cuda::std::same_as<void, decltype(T::operator()())>);
  }

  {
    ...
    cuda::std::same_as<MoveOnly> decltype(auto) result = T::operator()(m1, cuda::std::move(m2), cuda::std::move(m3));
    assert(result.get() == 6);
  }

  {
    ...
    cuda::std::same_as<bool> decltype(auto) result = T::operator()(5);
    assert(result);
  }

  {
    ...
    using T                                                                     = cuda::std::constant_wrapper<fun_ptr>;
    cuda::std::same_as<cuda::std::constant_wrapper<true>> decltype(auto) result = T::operator()(cuda::std::cw<5>);
  ...
  }
  {
    ...
    S s1;
    cuda::std::same_as<int&> decltype(auto) result = T::operator()(s1);
    assert(result == 42);
  ...
  }
  {
    ...
    using T                                                                   = cuda::std::constant_wrapper<&S::member>;
    cuda::std::same_as<cuda::std::constant_wrapper<42>> decltype(auto) result = T::operator()(cuda::std::cw<&s>);
    static_assert(result == 42);
  }
  {
    ...
    S s1;
    cuda::std::same_as<int> decltype(auto) result = T::operator()(s1, 8);
    assert(result == 50);
  }
  {
    // member function ptr with constexpr param
    using T = cuda::std::constant_wrapper<&S::mem_fun>;
    cuda::std::same_as<cuda::std::constant_wrapper<50>> decltype(auto) result =
      T::operator()(cuda::std::cw<&s>, cuda::std::cw<8>);
  ...
  }
  {
    ...
    cuda::std::same_as<int> decltype(auto) result1 = T::operator()(42);
    assert(result1 == 1);
    cuda::std::same_as<cuda::std::constant_wrapper<1>> decltype(auto) result2 = T::operator()(cuda::std::cw<42>);
...

  {
    ...
    cuda::std::same_as<NonStructural> decltype(auto) result = T::operator()(5);
    assert(result.get() == 5);
  }

  {
    ...
    using T                                                 = cuda::std::constant_wrapper<ReturnNonStructural{}>;
    cuda::std::same_as<NonStructural> decltype(auto) result = T::operator()(cuda::std::cw<5>);
    assert(result.get() == 5);
  }

  {
    ...
    cuda::std::same_as<int> decltype(auto) result = T::operator()(cuda::std::cw<42>);
    assert(result == 42);
  }

  {
    // just use the call operator
    assert(cuda::std::cw<[](int i) {
             return i + 1;
           }>(42)
           == 43);
    assert(cuda::std::cw<[](int i) {
...

  {
    ...
    cuda::std::same_as<cuda::std::constant_wrapper<3>> decltype(auto) result = T::operator()(ic1, ic2);
    static_assert(result == 3);
  }
