...
// Converts a chrono date and weekday to a given _Tm type.
//
...
#  endif
  ...
  else if constexpr (same_as<_ChronoT, chrono::year_month_weekday> || same_as<_ChronoT, chrono::year_month_weekday_last>)
  {
