...
_LIBCUDACXX_HIDE_FROM_ABI constexpr year_month& year_month::operator+=(const months& __dm) noexcept
{
  *this = *this + __dm;
  return *this;
}
...
_LIBCUDACXX_HIDE_FROM_ABI constexpr year_month& year_month::operator+=(const years& __dy) noexcept
{
  *this = *this + __dy;
  return *this;
}
