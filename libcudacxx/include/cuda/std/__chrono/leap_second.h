...
public:
  ...
  [[nodiscard]] _LIBCPP_HIDE_FROM_ABI constexpr sys_seconds date() const noexcept
  {
    return __date_;
  }

  [[nodiscard]] _LIBCPP_HIDE_FROM_ABI constexpr seconds value() const noexcept
  {
    return __value_;
  }
...
private:
  ...
  // to make the function a hidden friend. For consistency make this change for
