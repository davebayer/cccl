...
_CCCL_HOST_DEVICE inline void __atomic_thread_fence_dispatch(memory_order __order)
{
  NV_DISPATCH_TARGET(
    NV_IS_DEVICE,
    (_CUDA_VSTD::__atomic_thread_fence_cuda(
       static_cast<__memory_order_underlying_t>(__order), __thread_scope_system_tag());),
    NV_IS_HOST,
    (_CUDA_VSTD::__atomic_thread_fence_host(__order);))
}

_CCCL_HOST_DEVICE inline void __atomic_signal_fence_dispatch(memory_order __order)
{
  NV_DISPATCH_TARGET(NV_IS_DEVICE,
                     (_CUDA_VSTD::__atomic_signal_fence_cuda(static_cast<__memory_order_underlying_t>(__order));),
                     NV_IS_HOST,
                     (_CUDA_VSTD::__atomic_signal_fence_host(__order);))
}
...
{
  _CUDA_VSTD::__atomic_assign_volatile(__a->get(), __val);
}
...
_CCCL_HOST_DEVICE inline void __atomic_store_dispatch(_Sto* __a, _Up __val, memory_order __order, _Sco = {})
{
  NV_DISPATCH_TARGET(
    NV_IS_DEVICE,
    (_CUDA_VSTD::__atomic_store_n_cuda(__a->get(), __val, static_cast<__memory_order_underlying_t>(__order), _Sco{});),
    NV_IS_HOST,
    (_CUDA_VSTD::__atomic_store_host(__a->get(), __val, __order);))
}
  ...
  -> __atomic_underlying_t<_Sto>
{
  NV_DISPATCH_TARGET(
    NV_IS_DEVICE,
    (return _CUDA_VSTD::__atomic_load_n_cuda(__a->get(), static_cast<__memory_order_underlying_t>(__order), _Sco{});),
    NV_IS_HOST,
    (return _CUDA_VSTD::__atomic_load_host(__a->get(), __order);))
  _CCCL_UNREACHABLE();
}
  ...
  -> __atomic_underlying_t<_Sto>
{
  NV_DISPATCH_TARGET(
    NV_IS_DEVICE,
    (return _CUDA_VSTD::__atomic_exchange_n_cuda(
              __a->get(), __value, static_cast<__memory_order_underlying_t>(__order), _Sco{});),
    NV_IS_HOST,
    (return _CUDA_VSTD::__atomic_exchange_host(__a->get(), __value, __order);))
  _CCCL_UNREACHABLE();
}
  ...
  _Sto* __a, _Up* __expected, _Up __val, memory_order __success, memory_order __failure, _Sco = {})
{
  ...
  NV_DISPATCH_TARGET(
    NV_IS_DEVICE,
    (__result = _CUDA_VSTD::__atomic_compare_exchange_cuda(
       __a->get(),
       __expected,
       __val,
       false,
       ...
       _Sco{});),
    NV_IS_HOST,
    (__result = _CUDA_VSTD::__atomic_compare_exchange_strong_host(__a->get(), __expected, __val, __success, __failure);))
  return __result;
}
  ...
  _Sto* __a, _Up* __expected, _Up __val, memory_order __success, memory_order __failure, _Sco = {})
{
  ...
  NV_DISPATCH_TARGET(
    ...
    (__result = _CUDA_VSTD::__atomic_compare_exchange_cuda(
       ...
       _Sco{});),
    NV_IS_HOST,
    (__result = _CUDA_VSTD::__atomic_compare_exchange_weak_host(__a->get(), __expected, __val, __success, __failure);))
  return __result;
}
  ...
  -> __atomic_underlying_t<_Sto>
{
  NV_DISPATCH_TARGET(
    NV_IS_DEVICE,
    (return _CUDA_VSTD::__atomic_fetch_add_cuda(
              __a->get(), __delta, static_cast<__memory_order_underlying_t>(__order), _Sco{});),
    NV_IS_HOST,
    (return _CUDA_VSTD::__atomic_fetch_add_host(__a->get(), __delta, __order);))
  _CCCL_UNREACHABLE();
}
  ...
  -> __atomic_underlying_t<_Sto>
{
  NV_DISPATCH_TARGET(
    NV_IS_DEVICE,
    (return _CUDA_VSTD::__atomic_fetch_sub_cuda(
              __a->get(), __delta, static_cast<__memory_order_underlying_t>(__order), _Sco{});),
    NV_IS_HOST,
    (return _CUDA_VSTD::__atomic_fetch_sub_host(__a->get(), __delta, __order);))
  _CCCL_UNREACHABLE();
}
  ...
  -> __atomic_underlying_t<_Sto>
{
  NV_DISPATCH_TARGET(
    NV_IS_DEVICE,
    (return _CUDA_VSTD::__atomic_fetch_and_cuda(
              __a->get(), __pattern, static_cast<__memory_order_underlying_t>(__order), _Sco{});),
    NV_IS_HOST,
    (return _CUDA_VSTD::__atomic_fetch_and_host(__a->get(), __pattern, __order);))
  _CCCL_UNREACHABLE();
}
  ...
  -> __atomic_underlying_t<_Sto>
{
  NV_DISPATCH_TARGET(
    NV_IS_DEVICE,
    (return _CUDA_VSTD::__atomic_fetch_or_cuda(
              __a->get(), __pattern, static_cast<__memory_order_underlying_t>(__order), _Sco{});),
    NV_IS_HOST,
    (return _CUDA_VSTD::__atomic_fetch_or_host(__a->get(), __pattern, __order);))
  _CCCL_UNREACHABLE();
}
  ...
  -> __atomic_underlying_t<_Sto>
{
  NV_DISPATCH_TARGET(
    NV_IS_DEVICE,
    (return _CUDA_VSTD::__atomic_fetch_xor_cuda(
              __a->get(), __pattern, static_cast<__memory_order_underlying_t>(__order), _Sco{});),
    NV_IS_HOST,
    (return _CUDA_VSTD::__atomic_fetch_xor_host(__a->get(), __pattern, __order);))
  _CCCL_UNREACHABLE();
}
  ...
  -> __atomic_underlying_t<_Sto>
{
  NV_IF_TARGET(NV_IS_DEVICE,
               (return _CUDA_VSTD::__atomic_fetch_max_cuda(
                         __a->get(), __val, static_cast<__memory_order_underlying_t>(__order), _Sco{});),
               (return _CUDA_VSTD::__atomic_fetch_max_host(__a->get(), __val, __order);))
}
...
{
  NV_IF_TARGET(NV_IS_DEVICE,
               (return _CUDA_VSTD::__atomic_fetch_min_cuda(
                         __a->get(), __val, static_cast<__memory_order_underlying_t>(__order), _Sco{});),
               (return _CUDA_VSTD::__atomic_fetch_min_host(__a->get(), __val, __order);))
}
